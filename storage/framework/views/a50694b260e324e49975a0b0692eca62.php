...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container mt-4">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1>Assunto: <?php echo e($assunto->descricao); ?></h1>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('assuntos.update', ['assunto' => $assunto->codAs])); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('descricao', $assunto->descricao)); ?>">
                        </li>
                    </ul>
                </div>
                ...
                <div class="mt-4 d-flex justify-content-start">
                    ...
                    <a href="<?php echo e(route('assuntos.show', ['assunto' => $assunto->codAs])); ?>" class="btn btn-secondary">
...
<?php endif; ?>
<?php /**PATH /private/var/www/desafio_tecnico/livros/resources/views/assuntos/edit.blade.php ENDPATH**/ ?>