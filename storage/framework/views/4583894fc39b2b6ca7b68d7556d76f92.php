...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container mt-4">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1>Autor: <?php echo e($autore->nome); ?></h1>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('autores.update', $autore->codAu)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('nome', $autore->nome)); ?>">
                        </li>
                    </ul>
                </div>
...
<?php endif; ?>
<?php /**PATH /private/var/www/desafio_tecnico/livros/resources/views/autores/edit.blade.php ENDPATH**/ ?>