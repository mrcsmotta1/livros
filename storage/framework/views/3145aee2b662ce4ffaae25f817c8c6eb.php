...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="h4 fw-semibold text-dark">
            <?php echo e(__('Lista de Assuntos')); ?>
    ...
    <div class="container mt-4">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1>Assuntos</h1>
            <a href="<?php echo e(route('assuntos.create')); ?>" class="btn btn-primary">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 align-middle table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $assuntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assunto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($assunto->descricao); ?></td>
                                        <td class="text-center">
                                            <a href="<?php echo e(route('assuntos.show', $assunto->codAs)); ?>"
                                                class="btn btn-sm btn-info">
                                                <i class="bi bi-eye"></i></a>
                                            <a href="<?php echo e(route('assuntos.edit', $assunto->codAs)); ?>"
                                                class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil"></i></a>
                                            <form action="<?php echo e(route('assuntos.destroy', $assunto->codAs)); ?>"
                            ...
                            <div class="mt-3 d-flex justify-content-center">
                                <?php echo e($assuntos->links('pagination::bootstrap-5')); ?>
...
<?php endif; ?>
<?php /**PATH /private/var/www/desafio_tecnico/livros/resources/views/assuntos/index.blade.php ENDPATH**/ ?>