            ...
            <div class="card-body">
                ...
                <div class="mb-2 row">
                    <div class="col-md-6">
                        ...
                        <p class="mb-1"><strong>Ano de Publicação:</strong> {{ $livro->ano_publicacao ?? '—' }}</p>
                    </div>
                    <div class="col-md-6">
                    ...
                    <ul class="list-group">
                        @foreach ($livro->autores as $autor)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {{ $autor->nome }}
                                <a href="{{ route('autores.show', $autor->codAu) }}" class="btn btn-sm btn-outline-info">
                ...
                @if ($livro->assuntos->count() > 0)
                    <ul class="list-group">
                        @foreach ($livro->assuntos as $assunto)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {{ $assunto->descricao }}
                                <a href="{{ route('assuntos.show', $assunto->codAs) }}" class="btn btn-sm btn-outline-info">
