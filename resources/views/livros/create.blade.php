        ...
        <form id="form-livro" action="{{ route('livros.store') }}" method="POST">
            ...
            <div class="mb-3 row">
                <div class="col-md-4">
                    ...
                    <input type="number" name="edicao" id="edicao" class="form-control" min="1" step="1"
                        oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                </div>
                <div class="col-md-4">
                    <label for="ano_publicacao" class="form-label">Ano de Publicação</label>
                    <input type="text" name="ano_publicacao" id="ano_publicacao" class="form-control" maxlength="4"
                        oninput="this.value = this.value.replace(/[^0-9]/g, '')">
